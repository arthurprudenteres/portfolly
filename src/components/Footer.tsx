    ...
    <footer className="py-12">
      <div className="flex items-center justify-center">
        <div className="text-white">
          <a
            className="flex justify-center p-2 space-x-2 hover:scale-110 transition duration-200"
            href="https://discord.com/invite/SdkwDvn2"
          >
            <svg
        ...
        <div className="text-white">
          <a
            className="flex justify-center p-2 space-x-2 hover:scale-110 transition duration-200"
            href="https://github.com/arthurprudenteres"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="28"
        ...
        <div className="text-white">
          <a
            className="flex justify-center p-2 space-x-2 hover:scale-110 transition duration-200"
            href="https://www.linkedin.com/in/arthur-prudente-resende/"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="28"
